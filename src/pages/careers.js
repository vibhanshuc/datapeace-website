  ...
  return (
    <div className="careers">
      ...
      <div className="careers-section padded">
          ...
          <div className="flex flex-col">
            ...
            <div>
              <p>
                ...
                commercially viable products and services in the space of Cloud
                Enablement, Deep Learning, Machine Learning & Big Data. We
                encourage our people to dive in, roll up their sleeves and take
                on the many opportunities bound to come their way. We believe
                that in order to encourage an environment where technology
                thrives we must create one where employees thrive too.
              </p>
        ...
        <div>
          <h3>
            ...
            it’s fast-paced, oriented towards hard work , and still leaves room
          ...
          <div>
            ...
            <div>
              <div className="flex flex-col flex-center">
                <p>
                  Our team comprises of exceptional programmers having hands-on
      ...
      <div className="careers-section padded careers-jobs">
        <div className="flex flex-center mb-40">
            ...
            <div className="job-post">
              ...
              <div>
                <ul>
                  ...
                  <li>Basic knowledge of Pandas, Scipy, Spark, Hadoop will be a plus</li>
            ...
            <div className="job-post">
              ...
              <div>
                <ul>
                  ...
                  <li>Ability to learn and work in a fast paced environment</li>
